...
Route::get('/home/categories/{category}', [HomeController::class, 'categories'])->name('home.category');
Route::get('/orders/buy/{product}', [OrderController::class, 'buy'])->name('orders.buy');
