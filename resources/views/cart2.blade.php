...
@section('content')
      <div class="content-middle">
        ...
        <div class="cart-product-list">
            @forelse ($order->products as $order->product)
            <div class="cart-product-list__item">
                <div class="cart-product__item__product-photo"><img src="/img/cover/{{ $order->product->image}}" class="cart-product__item__product-photo__image"></div>
        ...
        <div class="content-footer__container">
          <div class="btn-buy-wrap"><a href="{{ route('orders.process') }}" class="btn-buy-wrap__btn-link">Перейти к оплате</a></div>
        </div>
      </div>
      @endsection
